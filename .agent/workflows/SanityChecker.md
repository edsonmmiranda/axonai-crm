...
4. **Passo 0 — Pré-condições:** Confirme que o sprint file tem `**Nível:** STANDARD` e que o PRD tem header `**Template:** PRD_STANDARD` ou `PRD_COMPLETE`. Rejeite sprints LIGHT com PRD (erro de roteamento — LIGHT roda Opção 1 sem PRD).
