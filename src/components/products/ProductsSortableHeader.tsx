...
import type { ProductSortKey } from '@/lib/products/constants';
import { parseSortParam, serializeSortParam } from './sort-utils';

interface ProductsSortableHeaderProps {
...
export function ProductsSortableHeader({
  sortKey,
  label,
  align = 'left',
  className,
}: ProductsSortableHeaderProps) {
