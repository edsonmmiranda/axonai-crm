...
import type { LossReasonSortKey } from '@/lib/loss-reasons/constants';
import { parseSortParam, serializeSortParam } from './sort-utils';

interface LossReasonsSortableHeaderProps {
  sortKey: LossReasonSortKey;
  label: string;
  align?: 'left' | 'right';
  className?: string;
}

export function LossReasonsSortableHeader({
  sortKey,
  label,
  align = 'left',
  className,
}: LossReasonsSortableHeaderProps) {
