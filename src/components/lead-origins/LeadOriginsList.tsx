...
import { LeadOriginsSortableHeader } from './LeadOriginsSortableHeader';
...
export function LeadOriginsList({ origins, hasFilter, metadata }: LeadOriginsListProps) {
  ...
  const total = metadata?.total ?? origins.length;
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full text-left text-sm">
          <thead className="border-b border-border-subtle bg-surface-sunken text-xs uppercase text-text-secondary">
            <tr>
              <LeadOriginsSortableHeader
                sortKey="name"
                label="Nome"
                className="pl-6 pr-3"
              />
              <LeadOriginsSortableHeader sortKey="type" label="Tipo" />
              <LeadOriginsSortableHeader sortKey="platform" label="Plataforma" />
              <LeadOriginsSortableHeader sortKey="is_active" label="Status" />
              <LeadOriginsSortableHeader sortKey="created_at" label="Criado em" />
              <th
                scope="col"
