...
import type { WhatsappGroupSortKey } from '@/lib/whatsapp-groups/constants';
import { parseSortParam, serializeSortParam } from './sort-utils';

interface WhatsappGroupsSortableHeaderProps {
  sortKey: WhatsappGroupSortKey;
  label: string;
  align?: 'left' | 'right';
  className?: string;
}

export function WhatsappGroupsSortableHeader({
  sortKey,
  label,
  align = 'left',
  className,
}: WhatsappGroupsSortableHeaderProps) {
